...
<div className="w-full flex flex-col rounded-md bg-richblack-800 p-6">
...
<div className="w-full rounded-md bg-richblack-800 p-6">
  ...
  <div className="my-4 grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
    {courses.map((course) => (
